                            ...
                            <Form>
                                <Card>
                                    ...
                                    <CardFooter className="text-right">
                                        ...
                                        <button className="primary" onClick={(e) => this.registerSubmit(e)}>Register</button>
                                    </CardFooter>
                                </Card>
                            </Form>
                        </Col>
                            ...
                            <Form>
                                <Card>
                                    ...
                                    <CardFooter className="text-center">
                                        <button className="primary" onClick={(e) => this.loginSubmit(e)}>Login</button>
                                    </CardFooter>
                                </Card>
                            </Form>
                        </Col>
                        <Col xs={12}>
                            <Form className="form-horizontal">
                                <Card>
                                    ...
                                    <CardFooter className="text-center">
                                        <button className="primary" onClick={(e) => this.typeValidate(e)}>Validate Inputs</button>
                                    </CardFooter>
                                </Card>
                            </Form>
                        </Col>
                        <Col xs={12}>
                            <Form className="form-horizontal">
                                <Card>
                                    ...
                                    <CardFooter className="text-center">
                                        <button className="primary" onClick={(e) => this.rangeValidate(e)}>Validate Inputs</button>
                                    </CardFooter>
                                </Card>
                            </Form>
                        </Col>
